# BeautifulSoup四个常用对象：
# 1、Tag：Tag通俗来讲就是HTML中一个个标签
# 2、BeautifulSoup: 这个属性继承自Tag
# 3、NavigableString：这个属性就是string文本
# 4、Comment: 这个属性继承自NavigableString
